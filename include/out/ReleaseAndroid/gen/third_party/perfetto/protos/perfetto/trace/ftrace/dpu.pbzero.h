...
class DpuDispDpuLineUnderrunFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
  DpuDispDpuLineUnderrunFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit DpuDispDpuLineUnderrunFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit DpuDispDpuLineUnderrunFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class DpuDispDpuLineUnderrunFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = DpuDispDpuLineUnderrunFtraceEvent_Decoder;
  enum : int32_t {
    kIdFieldNumber = 1,
    kFramesPendingFieldNumber = 2,
    kVsyncCountFieldNumber = 3,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.DpuDispDpuLineUnderrunFtraceEvent"; }
