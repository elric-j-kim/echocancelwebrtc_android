...
enum PerfEventConfig_UnwindMode : int {
  ...
  PerfEventConfig_UnwindMode_UNWIND_KERNEL_FRAME_POINTER = 4,
};
...
class PERFETTO_EXPORT_COMPONENT PerfEventConfig : public ::protozero::CppMessageObj {
 public:
  ...
  static constexpr auto UNWIND_KERNEL_FRAME_POINTER = PerfEventConfig_UnwindMode_UNWIND_KERNEL_FRAME_POINTER;
  static constexpr auto UnwindMode_MIN = PerfEventConfig_UnwindMode_UNWIND_UNKNOWN;
  static constexpr auto UnwindMode_MAX = PerfEventConfig_UnwindMode_UNWIND_KERNEL_FRAME_POINTER;
  enum FieldNumbers {
