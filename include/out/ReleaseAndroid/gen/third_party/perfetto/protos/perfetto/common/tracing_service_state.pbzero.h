...
class TracingServiceState_Producer_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8> {
 public:
  ...
  bool has_machine_id() const { return at<7>().valid(); }
  uint32_t machine_id() const { return at<7>().as_uint32(); }
  bool has_machine_name() const { return at<8>().valid(); }
  ::protozero::ConstChars machine_name() const { return at<8>().as_string(); }
};
...
class TracingServiceState_Producer : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_MachineName =
    ::protozero::proto_utils::FieldMetadata<
      8,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_MachineName kMachineName{};
  void set_machine_name(const char* data, size_t size) {
    AppendBytes(FieldMetadata_MachineName::kFieldId, data, size);
  }
  void set_machine_name(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_MachineName::kFieldId, chars.data, chars.size);
  }
  void set_machine_name(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_MachineName::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
