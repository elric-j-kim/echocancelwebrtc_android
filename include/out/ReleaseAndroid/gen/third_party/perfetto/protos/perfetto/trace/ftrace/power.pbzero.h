...
class PsciDomainIdleEnterFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
  PsciDomainIdleEnterFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit PsciDomainIdleEnterFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit PsciDomainIdleEnterFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  bool has_s2idle() const { return at<3>().valid(); }
  uint32_t s2idle() const { return at<3>().as_uint32(); }
};

class PsciDomainIdleEnterFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = PsciDomainIdleEnterFtraceEvent_Decoder;
  enum : int32_t {
    kCpuIdFieldNumber = 1,
    kStateFieldNumber = 2,
    kS2idleFieldNumber = 3,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.PsciDomainIdleEnterFtraceEvent"; }
  ...
  static constexpr FieldMetadata_S2idle kS2idle{};
  void set_s2idle(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_S2idle::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
...
class PsciDomainIdleExitFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
  PsciDomainIdleExitFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit PsciDomainIdleExitFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit PsciDomainIdleExitFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_cpu_id() const { return at<1>().valid(); }
  uint32_t cpu_id() const { return at<1>().as_uint32(); }
  bool has_state() const { return at<2>().valid(); }
  uint32_t state() const { return at<2>().as_uint32(); }
...
class PsciDomainIdleExitFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = PsciDomainIdleExitFtraceEvent_Decoder;
  enum : int32_t {
    kCpuIdFieldNumber = 1,
    kStateFieldNumber = 2,
    kS2idleFieldNumber = 3,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.PsciDomainIdleExitFtraceEvent"; }
