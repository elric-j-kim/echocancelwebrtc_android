...
constexpr TrackEvent_Type TrackEvent_Type_MAX = TrackEvent_Type::TYPE_STATE;
...
const char* TrackEvent_Type_Name(::perfetto::protos::pbzero::TrackEvent_Type value) {
  ...
  case ::perfetto::protos::pbzero::TrackEvent_Type::TYPE_STATE:
    return "TYPE_STATE";
  }
...
class TrackEvent : public ::protozero::Message {
 public:
  ...
  static inline const Type TYPE_STATE = Type::TYPE_STATE;
