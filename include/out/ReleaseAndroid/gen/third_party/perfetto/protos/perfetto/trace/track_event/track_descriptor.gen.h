...
enum TrackDescriptor_ProcessOrdering : int;
enum TrackDescriptor_ThreadOrdering : int;
...
enum TrackDescriptor_ProcessOrdering : int {
  TrackDescriptor_ProcessOrdering_PROCESS_ORDERING_UNSPECIFIED = 0,
  TrackDescriptor_ProcessOrdering_PROCESS_ORDERING_EXPLICIT = 1,
};
enum TrackDescriptor_ThreadOrdering : int {
  TrackDescriptor_ThreadOrdering_THREAD_ORDERING_UNSPECIFIED = 0,
  TrackDescriptor_ThreadOrdering_THREAD_ORDERING_EXPLICIT = 1,
};
...
class PERFETTO_EXPORT_COMPONENT TrackDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  using ProcessOrdering = TrackDescriptor_ProcessOrdering;
  static constexpr auto PROCESS_ORDERING_UNSPECIFIED = TrackDescriptor_ProcessOrdering_PROCESS_ORDERING_UNSPECIFIED;
  static constexpr auto PROCESS_ORDERING_EXPLICIT = TrackDescriptor_ProcessOrdering_PROCESS_ORDERING_EXPLICIT;
  static constexpr auto ProcessOrdering_MIN = TrackDescriptor_ProcessOrdering_PROCESS_ORDERING_UNSPECIFIED;
  static constexpr auto ProcessOrdering_MAX = TrackDescriptor_ProcessOrdering_PROCESS_ORDERING_EXPLICIT;
  using ThreadOrdering = TrackDescriptor_ThreadOrdering;
  static constexpr auto THREAD_ORDERING_UNSPECIFIED = TrackDescriptor_ThreadOrdering_THREAD_ORDERING_UNSPECIFIED;
  static constexpr auto THREAD_ORDERING_EXPLICIT = TrackDescriptor_ThreadOrdering_THREAD_ORDERING_EXPLICIT;
  static constexpr auto ThreadOrdering_MIN = TrackDescriptor_ThreadOrdering_THREAD_ORDERING_UNSPECIFIED;
  static constexpr auto ThreadOrdering_MAX = TrackDescriptor_ThreadOrdering_THREAD_ORDERING_EXPLICIT;
  enum FieldNumbers {
    kUuidFieldNumber = 1,
  ...
  bool has_state() const { return _has_field_[18]; }
  const StateDescriptor& state() const { return *state_; }
  StateDescriptor* mutable_state() { _has_field_.set(18); return state_.get(); }
  ...
  bool has_process_ordering() const { return _has_field_[19]; }
  TrackDescriptor_ProcessOrdering process_ordering() const { return process_ordering_; }
  void set_process_ordering(TrackDescriptor_ProcessOrdering value) { process_ordering_ = value; _has_field_.set(19); }

  bool has_thread_ordering() const { return _has_field_[20]; }
  TrackDescriptor_ThreadOrdering thread_ordering() const { return thread_ordering_; }
  void set_thread_ordering(TrackDescriptor_ThreadOrdering value) { thread_ordering_ = value; _has_field_.set(20); }
 ...
 private:
  ...
  ::protozero::CopyablePtr<StateDescriptor> state_;
  ...
  TrackDescriptor_ProcessOrdering process_ordering_{};
  TrackDescriptor_ThreadOrdering thread_ordering_{};
