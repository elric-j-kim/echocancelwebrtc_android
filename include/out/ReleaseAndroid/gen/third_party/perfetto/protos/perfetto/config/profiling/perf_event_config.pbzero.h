...
constexpr PerfEventConfig_UnwindMode PerfEventConfig_UnwindMode_MAX = PerfEventConfig_UnwindMode::UNWIND_KERNEL_FRAME_POINTER;
...
const char* PerfEventConfig_UnwindMode_Name(::perfetto::protos::pbzero::PerfEventConfig_UnwindMode value) {
  ...
  case ::perfetto::protos::pbzero::PerfEventConfig_UnwindMode::UNWIND_KERNEL_FRAME_POINTER:
    return "UNWIND_KERNEL_FRAME_POINTER";
  }
...
class PerfEventConfig : public ::protozero::Message {
 public:
  ...
  static inline const UnwindMode UNWIND_KERNEL_FRAME_POINTER = UnwindMode::UNWIND_KERNEL_FRAME_POINTER;
