...
enum GpuCounterDescriptor_GpuCounterSpec_ValueDirection : int;
}  // namespace perfetto
}  // namespace protos
}  // namespace gen
...
enum GpuCounterDescriptor_GpuCounterSpec_ValueDirection : int {
  GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_UNSPECIFIED = 0,
  GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_BACKWARDS_LOOKING = 1,
  GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_FORWARDS_LOOKING = 2,
};
...
class PERFETTO_EXPORT_COMPONENT GpuCounterDescriptor_GpuCounterSpec : public ::protozero::CppMessageObj {
 public:
  using ValueDirection = GpuCounterDescriptor_GpuCounterSpec_ValueDirection;
  static constexpr auto VALUE_DIRECTION_UNSPECIFIED = GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_UNSPECIFIED;
  static constexpr auto VALUE_DIRECTION_BACKWARDS_LOOKING = GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_BACKWARDS_LOOKING;
  static constexpr auto VALUE_DIRECTION_FORWARDS_LOOKING = GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_FORWARDS_LOOKING;
  static constexpr auto ValueDirection_MIN = GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_UNSPECIFIED;
  static constexpr auto ValueDirection_MAX = GpuCounterDescriptor_GpuCounterSpec_ValueDirection_VALUE_DIRECTION_FORWARDS_LOOKING;
  enum FieldNumbers {
  ...
  bool has_value_direction() const { return _has_field_[11]; }
  GpuCounterDescriptor_GpuCounterSpec_ValueDirection value_direction() const { return value_direction_; }
  void set_value_direction(GpuCounterDescriptor_GpuCounterSpec_ValueDirection value) { value_direction_ = value; _has_field_.set(11); }
 ...
 private:
  ...
  GpuCounterDescriptor_GpuCounterSpec_ValueDirection value_direction_{};
