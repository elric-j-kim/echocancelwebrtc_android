...
class DiskIoEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9> {
 public:
  DiskIoEtwEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit DiskIoEtwEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit DiskIoEtwEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_disk_number() const { return at<1>().valid(); }
  uint32_t disk_number() const { return at<1>().as_uint32(); }
  bool has_irp_flags() const { return at<2>().valid(); }
  uint32_t irp_flags() const { return at<2>().as_uint32(); }
  bool has_transfer_size() const { return at<3>().valid(); }
  uint32_t transfer_size() const { return at<3>().as_uint32(); }
  bool has_byte_offset() const { return at<4>().valid(); }
  int64_t byte_offset() const { return at<4>().as_int64(); }
  bool has_file_object() const { return at<5>().valid(); }
  uint64_t file_object() const { return at<5>().as_uint64(); }
  bool has_irp_ptr() const { return at<6>().valid(); }
  uint64_t irp_ptr() const { return at<6>().as_uint64(); }
  bool has_response_time() const { return at<7>().valid(); }
  int64_t response_time() const { return at<7>().as_int64(); }
  bool has_issuing_thread_id() const { return at<8>().valid(); }
  uint32_t issuing_thread_id() const { return at<8>().as_uint32(); }
  bool has_opcode() const { return at<9>().valid(); }
  uint32_t opcode() const { return at<9>().as_uint32(); }
};

class DiskIoEtwEvent : public ::protozero::Message {
 public:
  using Decoder = DiskIoEtwEvent_Decoder;
  enum : int32_t {
    kDiskNumberFieldNumber = 1,
    kIrpFlagsFieldNumber = 2,
    kTransferSizeFieldNumber = 3,
    kByteOffsetFieldNumber = 4,
    kFileObjectFieldNumber = 5,
    kIrpPtrFieldNumber = 6,
    kResponseTimeFieldNumber = 7,
    kIssuingThreadIdFieldNumber = 8,
    kOpcodeFieldNumber = 9,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.DiskIoEtwEvent"; }


  using FieldMetadata_DiskNumber =
  ...
  static constexpr FieldMetadata_DiskNumber kDiskNumber{};
  void set_disk_number(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_DiskNumber::kFieldId;
  ...
  static constexpr FieldMetadata_IrpFlags kIrpFlags{};
  void set_irp_flags(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IrpFlags::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  using FieldMetadata_TransferSize =
    ::protozero::proto_utils::FieldMetadata<
      3,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_TransferSize kTransferSize{};
  void set_transfer_size(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_TransferSize::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  void set_byte_offset(int64_t value) {
  ...
  using FieldMetadata_ResponseTime =
    ::protozero::proto_utils::FieldMetadata<
      7,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kInt64,
  ...
  static constexpr FieldMetadata_ResponseTime kResponseTime{};
  void set_response_time(int64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_ResponseTime::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt64>
  ...
  using FieldMetadata_IssuingThreadId =
    ::protozero::proto_utils::FieldMetadata<
      8,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_IssuingThreadId kIssuingThreadId{};
  void set_issuing_thread_id(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IssuingThreadId::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
...
class FileIoPathOperationEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8> {
 public:
  FileIoPathOperationEtwEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit FileIoPathOperationEtwEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit FileIoPathOperationEtwEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  bool has_file_name() const { return at<7>().valid(); }
  ::protozero::ConstChars file_name() const { return at<7>().as_string(); }
  bool has_opcode() const { return at<8>().valid(); }
  uint32_t opcode() const { return at<8>().as_uint32(); }
};

class FileIoPathOperationEtwEvent : public ::protozero::Message {
 public:
  using Decoder = FileIoPathOperationEtwEvent_Decoder;
  enum : int32_t {
  ...
  static constexpr const char* GetName() { return ".perfetto.protos.FileIoPathOperationEtwEvent"; }
