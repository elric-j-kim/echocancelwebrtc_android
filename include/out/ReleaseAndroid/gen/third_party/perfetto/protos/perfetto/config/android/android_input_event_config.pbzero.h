...
class AndroidInputEventConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_trace_evdev_events() const { return at<5>().valid(); }
  bool trace_evdev_events() const { return at<5>().as_bool(); }
};
...
class AndroidInputEventConfig : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kTraceEvdevEventsFieldNumber = 5,
  };
  ...
  using FieldMetadata_TraceEvdevEvents =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_TraceEvdevEvents kTraceEvdevEvents{};
  void set_trace_evdev_events(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_TraceEvdevEvents::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
