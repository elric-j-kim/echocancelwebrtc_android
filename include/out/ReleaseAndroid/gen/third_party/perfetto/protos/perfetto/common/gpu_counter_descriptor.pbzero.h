...
namespace perfetto_pbzero_enum_GpuCounterDescriptor_GpuCounterSpec {
enum ValueDirection : int32_t;
}  // namespace perfetto_pbzero_enum_GpuCounterDescriptor_GpuCounterSpec
using GpuCounterDescriptor_GpuCounterSpec_ValueDirection = perfetto_pbzero_enum_GpuCounterDescriptor_GpuCounterSpec::ValueDirection;
namespace perfetto_pbzero_enum_GpuCounterDescriptor {
...
constexpr GpuCounterDescriptor_GpuCounterSpec_ValueDirection GpuCounterDescriptor_GpuCounterSpec_ValueDirection_MIN = GpuCounterDescriptor_GpuCounterSpec_ValueDirection::VALUE_DIRECTION_UNSPECIFIED;
constexpr GpuCounterDescriptor_GpuCounterSpec_ValueDirection GpuCounterDescriptor_GpuCounterSpec_ValueDirection_MAX = GpuCounterDescriptor_GpuCounterSpec_ValueDirection::VALUE_DIRECTION_FORWARDS_LOOKING;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* GpuCounterDescriptor_GpuCounterSpec_ValueDirection_Name(::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterSpec_ValueDirection value) {
  switch (value) {
  case ::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterSpec_ValueDirection::VALUE_DIRECTION_UNSPECIFIED:
    return "VALUE_DIRECTION_UNSPECIFIED";

  case ::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterSpec_ValueDirection::VALUE_DIRECTION_BACKWARDS_LOOKING:
    return "VALUE_DIRECTION_BACKWARDS_LOOKING";

  case ::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterSpec_ValueDirection::VALUE_DIRECTION_FORWARDS_LOOKING:
    return "VALUE_DIRECTION_FORWARDS_LOOKING";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}
...
class GpuCounterDescriptor_GpuCounterSpec_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/11> {
 public:
  ...
  bool has_value_direction() const { return at<11>().valid(); }
  int32_t value_direction() const { return at<11>().as_int32(); }
};
...
class GpuCounterDescriptor_GpuCounterSpec : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kValueDirectionFieldNumber = 11,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.GpuCounterDescriptor.GpuCounterSpec"; }


  using ValueDirection = ::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterSpec_ValueDirection;
  static inline const char* ValueDirection_Name(ValueDirection value) {
    return ::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterSpec_ValueDirection_Name(value);
  }
  static inline const ValueDirection VALUE_DIRECTION_UNSPECIFIED = ValueDirection::VALUE_DIRECTION_UNSPECIFIED;
  static inline const ValueDirection VALUE_DIRECTION_BACKWARDS_LOOKING = ValueDirection::VALUE_DIRECTION_BACKWARDS_LOOKING;
  static inline const ValueDirection VALUE_DIRECTION_FORWARDS_LOOKING = ValueDirection::VALUE_DIRECTION_FORWARDS_LOOKING;
  ...
  using FieldMetadata_ValueDirection =
    ::protozero::proto_utils::FieldMetadata<
      11,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      GpuCounterDescriptor_GpuCounterSpec_ValueDirection,
      GpuCounterDescriptor_GpuCounterSpec>;

  static constexpr FieldMetadata_ValueDirection kValueDirection{};
  void set_value_direction(GpuCounterDescriptor_GpuCounterSpec_ValueDirection value) {
    static constexpr uint32_t field_id = FieldMetadata_ValueDirection::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
