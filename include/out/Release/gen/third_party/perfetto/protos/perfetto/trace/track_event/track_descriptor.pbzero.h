...
namespace perfetto_pbzero_enum_TrackDescriptor {
enum ProcessOrdering : int32_t;
}  // namespace perfetto_pbzero_enum_TrackDescriptor
using TrackDescriptor_ProcessOrdering = perfetto_pbzero_enum_TrackDescriptor::ProcessOrdering;
namespace perfetto_pbzero_enum_TrackDescriptor {
...
namespace perfetto_pbzero_enum_TrackDescriptor {
enum ThreadOrdering : int32_t;
}  // namespace perfetto_pbzero_enum_TrackDescriptor
using TrackDescriptor_ThreadOrdering = perfetto_pbzero_enum_TrackDescriptor::ThreadOrdering;
} // Namespace pbzero.
} // Namespace protos.
} // Namespace perfetto.
...
constexpr TrackDescriptor_ProcessOrdering TrackDescriptor_ProcessOrdering_MIN = TrackDescriptor_ProcessOrdering::PROCESS_ORDERING_UNSPECIFIED;
constexpr TrackDescriptor_ProcessOrdering TrackDescriptor_ProcessOrdering_MAX = TrackDescriptor_ProcessOrdering::PROCESS_ORDERING_EXPLICIT;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* TrackDescriptor_ProcessOrdering_Name(::perfetto::protos::pbzero::TrackDescriptor_ProcessOrdering value) {
  switch (value) {
  case ::perfetto::protos::pbzero::TrackDescriptor_ProcessOrdering::PROCESS_ORDERING_UNSPECIFIED:
    return "PROCESS_ORDERING_UNSPECIFIED";

  case ::perfetto::protos::pbzero::TrackDescriptor_ProcessOrdering::PROCESS_ORDERING_EXPLICIT:
    return "PROCESS_ORDERING_EXPLICIT";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}
...
constexpr TrackDescriptor_ThreadOrdering TrackDescriptor_ThreadOrdering_MIN = TrackDescriptor_ThreadOrdering::THREAD_ORDERING_UNSPECIFIED;
constexpr TrackDescriptor_ThreadOrdering TrackDescriptor_ThreadOrdering_MAX = TrackDescriptor_ThreadOrdering::THREAD_ORDERING_EXPLICIT;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* TrackDescriptor_ThreadOrdering_Name(::perfetto::protos::pbzero::TrackDescriptor_ThreadOrdering value) {
  switch (value) {
  case ::perfetto::protos::pbzero::TrackDescriptor_ThreadOrdering::THREAD_ORDERING_UNSPECIFIED:
    return "THREAD_ORDERING_UNSPECIFIED";

  case ::perfetto::protos::pbzero::TrackDescriptor_ThreadOrdering::THREAD_ORDERING_EXPLICIT:
    return "THREAD_ORDERING_EXPLICIT";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}

class TrackDescriptor_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/20> {
 public:
  ...
  bool has_state() const { return at<18>().valid(); }
  ::protozero::ConstBytes state() const { return at<18>().as_bytes(); }
  ...
  bool has_process_ordering() const { return at<19>().valid(); }
  int32_t process_ordering() const { return at<19>().as_int32(); }
  bool has_thread_ordering() const { return at<20>().valid(); }
  int32_t thread_ordering() const { return at<20>().as_int32(); }
};
...
class TrackDescriptor : public ::protozero::Message {
 public:
  ...
  using ProcessOrdering = ::perfetto::protos::pbzero::TrackDescriptor_ProcessOrdering;
  static inline const char* ProcessOrdering_Name(ProcessOrdering value) {
    return ::perfetto::protos::pbzero::TrackDescriptor_ProcessOrdering_Name(value);
  }

  using ThreadOrdering = ::perfetto::protos::pbzero::TrackDescriptor_ThreadOrdering;
  static inline const char* ThreadOrdering_Name(ThreadOrdering value) {
    return ::perfetto::protos::pbzero::TrackDescriptor_ThreadOrdering_Name(value);
  }
  ...
  static inline const ProcessOrdering PROCESS_ORDERING_UNSPECIFIED = ProcessOrdering::PROCESS_ORDERING_UNSPECIFIED;
  static inline const ProcessOrdering PROCESS_ORDERING_EXPLICIT = ProcessOrdering::PROCESS_ORDERING_EXPLICIT;
  static inline const ThreadOrdering THREAD_ORDERING_UNSPECIFIED = ThreadOrdering::THREAD_ORDERING_UNSPECIFIED;
  static inline const ThreadOrdering THREAD_ORDERING_EXPLICIT = ThreadOrdering::THREAD_ORDERING_EXPLICIT;
  ...
  template <typename T = StateDescriptor> T* set_state() {
  ...
  using FieldMetadata_ProcessOrdering =
    ::protozero::proto_utils::FieldMetadata<
      19,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      TrackDescriptor_ProcessOrdering,
      TrackDescriptor>;

  static constexpr FieldMetadata_ProcessOrdering kProcessOrdering{};
  void set_process_ordering(TrackDescriptor_ProcessOrdering value) {
    static constexpr uint32_t field_id = FieldMetadata_ProcessOrdering::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
  ...
  using FieldMetadata_ThreadOrdering =
    ::protozero::proto_utils::FieldMetadata<
      20,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      TrackDescriptor_ThreadOrdering,
      TrackDescriptor>;

  static constexpr FieldMetadata_ThreadOrdering kThreadOrdering{};
  void set_thread_ordering(TrackDescriptor_ThreadOrdering value) {
    static constexpr uint32_t field_id = FieldMetadata_ThreadOrdering::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
