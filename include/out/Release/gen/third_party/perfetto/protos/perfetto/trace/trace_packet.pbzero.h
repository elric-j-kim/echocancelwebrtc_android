...
using TracePacket_DataLossReason = perfetto_pbzero_enum_TracePacket::DataLossReason;


constexpr TracePacket_DataLossReason TracePacket_DataLossReason_MIN = TracePacket_DataLossReason::DATA_LOSS_UNSPECIFIED;
constexpr TracePacket_DataLossReason TracePacket_DataLossReason_MAX = TracePacket_DataLossReason::DATA_LOSS_SMB_FULL;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* TracePacket_DataLossReason_Name(::perfetto::protos::pbzero::TracePacket_DataLossReason value) {
  switch (value) {
  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_UNSPECIFIED:
    return "DATA_LOSS_UNSPECIFIED";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_PRESENT:
    return "DATA_LOSS_PRESENT";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_READ_GAP:
    return "DATA_LOSS_READ_GAP";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_CHUNK_CORRUPTED:
    return "DATA_LOSS_CHUNK_CORRUPTED";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_ORPHAN_CONTINUATION:
    return "DATA_LOSS_ORPHAN_CONTINUATION";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_REASSEMBLY_GAP:
    return "DATA_LOSS_REASSEMBLY_GAP";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_REASSEMBLY_BROKEN_CHAIN:
    return "DATA_LOSS_REASSEMBLY_BROKEN_CHAIN";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_OVERWRITE:
    return "DATA_LOSS_OVERWRITE";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_WRITER_ABORT:
    return "DATA_LOSS_WRITER_ABORT";

  case ::perfetto::protos::pbzero::TracePacket_DataLossReason::DATA_LOSS_SMB_FULL:
    return "DATA_LOSS_SMB_FULL";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}
...
class TracePacket_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/900> {
 public:
  ...
  bool has_art_process_metadata() const { return at<131>().valid(); }
  ::protozero::ConstBytes art_process_metadata() const { return at<131>().as_bytes(); }
  ...
  bool has_interrupt_info() const { return at<130>().valid(); }
  ::protozero::ConstBytes interrupt_info() const { return at<130>().as_bytes(); }
  ...
  bool has_journald_event() const { return at<132>().valid(); }
  ::protozero::ConstBytes journald_event() const { return at<132>().as_bytes(); }
  ...
  uint32_t previous_packet_dropped() const { return at<42>().as_uint32(); }
...
class TracePacket : public ::protozero::Message {
 public:
  ...
  using DataLossReason = ::perfetto::protos::pbzero::TracePacket_DataLossReason;
  static inline const char* DataLossReason_Name(DataLossReason value) {
    return ::perfetto::protos::pbzero::TracePacket_DataLossReason_Name(value);
  }
  ...
  static inline const DataLossReason DATA_LOSS_UNSPECIFIED = DataLossReason::DATA_LOSS_UNSPECIFIED;
  static inline const DataLossReason DATA_LOSS_PRESENT = DataLossReason::DATA_LOSS_PRESENT;
  static inline const DataLossReason DATA_LOSS_READ_GAP = DataLossReason::DATA_LOSS_READ_GAP;
  static inline const DataLossReason DATA_LOSS_CHUNK_CORRUPTED = DataLossReason::DATA_LOSS_CHUNK_CORRUPTED;
  static inline const DataLossReason DATA_LOSS_ORPHAN_CONTINUATION = DataLossReason::DATA_LOSS_ORPHAN_CONTINUATION;
  static inline const DataLossReason DATA_LOSS_REASSEMBLY_GAP = DataLossReason::DATA_LOSS_REASSEMBLY_GAP;
  static inline const DataLossReason DATA_LOSS_REASSEMBLY_BROKEN_CHAIN = DataLossReason::DATA_LOSS_REASSEMBLY_BROKEN_CHAIN;
  static inline const DataLossReason DATA_LOSS_OVERWRITE = DataLossReason::DATA_LOSS_OVERWRITE;
  static inline const DataLossReason DATA_LOSS_WRITER_ABORT = DataLossReason::DATA_LOSS_WRITER_ABORT;
  static inline const DataLossReason DATA_LOSS_SMB_FULL = DataLossReason::DATA_LOSS_SMB_FULL;
  ...
  using FieldMetadata_ArtProcessMetadata =
    ::protozero::proto_utils::FieldMetadata<
      131,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_ArtProcessMetadata kArtProcessMetadata{};
  template <typename T = ArtProcessMetadata> T* set_art_process_metadata() {
  ...
  using FieldMetadata_InterruptInfo =
    ::protozero::proto_utils::FieldMetadata<
      130,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_InterruptInfo kInterruptInfo{};
  template <typename T = InterruptInfo> T* set_interrupt_info() {
  ...
  using FieldMetadata_JournaldEvent =
    ::protozero::proto_utils::FieldMetadata<
      132,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_JournaldEvent kJournaldEvent{};
  template <typename T = SystemdJournaldEvent> T* set_journald_event() {
  ...
  void set_previous_packet_dropped(uint32_t value) {
