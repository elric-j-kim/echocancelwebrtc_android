...
class EtwConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/7> {
 public:
  ...
  bool has_disk_provider_events() const { return at<6>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstChars> disk_provider_events() const { return GetRepeated<::protozero::ConstChars>(6); }
  bool has_system_io_provider_events() const { return at<7>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstChars> system_io_provider_events() const { return GetRepeated<::protozero::ConstChars>(7); }
};
...
class EtwConfig : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kDiskProviderEventsFieldNumber = 6,
    kSystemIoProviderEventsFieldNumber = 7,
  };
  ...
  using FieldMetadata_DiskProviderEvents =
    ::protozero::proto_utils::FieldMetadata<
      6,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_DiskProviderEvents kDiskProviderEvents{};
  void add_disk_provider_events(const char* data, size_t size) {
    AppendBytes(FieldMetadata_DiskProviderEvents::kFieldId, data, size);
  }
  void add_disk_provider_events(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_DiskProviderEvents::kFieldId, chars.data, chars.size);
  }
  void add_disk_provider_events(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_DiskProviderEvents::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  using FieldMetadata_SystemIoProviderEvents =
    ::protozero::proto_utils::FieldMetadata<
      7,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_SystemIoProviderEvents kSystemIoProviderEvents{};
  void add_system_io_provider_events(const char* data, size_t size) {
    AppendBytes(FieldMetadata_SystemIoProviderEvents::kFieldId, data, size);
  }
  void add_system_io_provider_events(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_SystemIoProviderEvents::kFieldId, chars.data, chars.size);
  }
  void add_system_io_provider_events(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_SystemIoProviderEvents::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
