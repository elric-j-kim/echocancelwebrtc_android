...
class PERFETTO_EXPORT_COMPONENT TracingServiceState_Producer : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_machine_id() const { return _has_field_[7]; }
  uint32_t machine_id() const { return machine_id_; }
  void set_machine_id(uint32_t value) { machine_id_ = value; _has_field_.set(7); }

  bool has_machine_name() const { return _has_field_[8]; }
  const std::string& machine_name() const { return machine_name_; }
  void set_machine_name(const std::string& value) { machine_name_ = value; _has_field_.set(8); }
