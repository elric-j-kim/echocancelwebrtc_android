...
class PERFETTO_EXPORT_COMPONENT JavaHprofConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_min_java_heap_size_kb() const { return _has_field_[9]; }
  uint32_t min_java_heap_size_kb() const { return min_java_heap_size_kb_; }
  void set_min_java_heap_size_kb(uint32_t value) { min_java_heap_size_kb_ = value; _has_field_.set(9); }
  ...
  bool has_smaps_config() const { return _has_field_[8]; }
  const SmapsConfig& smaps_config() const { return *smaps_config_; }
  SmapsConfig* mutable_smaps_config() { _has_field_.set(8); return smaps_config_.get(); }
  ...
  bool has_dump_oome_callstack() const { return _has_field_[10]; }
  bool dump_oome_callstack() const { return dump_oome_callstack_; }
  void set_dump_oome_callstack(bool value) { dump_oome_callstack_ = value; _has_field_.set(10); }
 ...
 private:
  ...
  uint32_t min_java_heap_size_kb_{};
  bool dump_smaps_{};
  ::protozero::CopyablePtr<SmapsConfig> smaps_config_;
  std::vector<std::string> ignored_types_;
  bool dump_oome_callstack_{};
