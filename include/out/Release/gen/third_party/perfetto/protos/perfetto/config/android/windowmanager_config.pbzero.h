...
using WindowManagerConfig_LogMode = perfetto_pbzero_enum_WindowManagerConfig::LogMode;
} // Namespace pbzero.
} // Namespace protos.
} // Namespace perfetto.
...
enum LogMode : int32_t {
  ...
  LOG_MODE_FULL_STATE = 1,
  LOG_MODE_INCREMENTAL = 2,
};
} // namespace perfetto_pbzero_enum_WindowManagerConfig
using WindowManagerConfig_LogMode = perfetto_pbzero_enum_WindowManagerConfig::LogMode;


constexpr WindowManagerConfig_LogMode WindowManagerConfig_LogMode_MIN = WindowManagerConfig_LogMode::LOG_MODE_UNSPECIFIED;
constexpr WindowManagerConfig_LogMode WindowManagerConfig_LogMode_MAX = WindowManagerConfig_LogMode::LOG_MODE_INCREMENTAL;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* WindowManagerConfig_LogMode_Name(::perfetto::protos::pbzero::WindowManagerConfig_LogMode value) {
  switch (value) {
  case ::perfetto::protos::pbzero::WindowManagerConfig_LogMode::LOG_MODE_UNSPECIFIED:
    return "LOG_MODE_UNSPECIFIED";

  case ::perfetto::protos::pbzero::WindowManagerConfig_LogMode::LOG_MODE_FULL_STATE:
    return "LOG_MODE_FULL_STATE";

  case ::perfetto::protos::pbzero::WindowManagerConfig_LogMode::LOG_MODE_INCREMENTAL:
    return "LOG_MODE_INCREMENTAL";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}

class WindowManagerConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
  ...
  bool has_log_mode() const { return at<3>().valid(); }
  int32_t log_mode() const { return at<3>().as_int32(); }
};
...
class WindowManagerConfig : public ::protozero::Message {
 public:
  ...
  using LogMode = ::perfetto::protos::pbzero::WindowManagerConfig_LogMode;
  static inline const char* LogMode_Name(LogMode value) {
    return ::perfetto::protos::pbzero::WindowManagerConfig_LogMode_Name(value);
  }
  ...
  static inline const LogMode LOG_MODE_UNSPECIFIED = LogMode::LOG_MODE_UNSPECIFIED;
  static inline const LogMode LOG_MODE_FULL_STATE = LogMode::LOG_MODE_FULL_STATE;
  static inline const LogMode LOG_MODE_INCREMENTAL = LogMode::LOG_MODE_INCREMENTAL;
  ...
  using FieldMetadata_LogMode =
    ::protozero::proto_utils::FieldMetadata<
      3,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      WindowManagerConfig_LogMode,
      WindowManagerConfig>;

  static constexpr FieldMetadata_LogMode kLogMode{};
  void set_log_mode(WindowManagerConfig_LogMode value) {
    static constexpr uint32_t field_id = FieldMetadata_LogMode::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
