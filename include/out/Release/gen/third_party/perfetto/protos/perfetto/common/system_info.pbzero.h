...
class SystemInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/17> {
 public:
  ...
  bool has_machine_name() const { return at<17>().valid(); }
  ::protozero::ConstChars machine_name() const { return at<17>().as_string(); }
};
