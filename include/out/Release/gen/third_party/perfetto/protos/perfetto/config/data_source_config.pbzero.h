...
class DataSourceConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/150> {
 public:
  ...
  bool has_journald_config() const { return at<141>().valid(); }
  ::protozero::ConstBytes journald_config() const { return at<141>().as_bytes(); }
  bool has_display_video_config() const { return at<142>().valid(); }
  ::protozero::ConstBytes display_video_config() const { return at<142>().as_bytes(); }
...
class DataSourceConfig : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kJournaldConfigFieldNumber = 141,
    kDisplayVideoConfigFieldNumber = 142,
  ...
  using FieldMetadata_JournaldConfig =
    ::protozero::proto_utils::FieldMetadata<
      141,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_JournaldConfig kJournaldConfig{};
  template <typename T = SystemdJournaldConfig> T* set_journald_config() {
    return BeginNestedMessage<T>(141);
  }

  void set_journald_config_raw(const std::string& raw) {
    return AppendBytes(141, raw.data(), raw.size());
  }


  using FieldMetadata_DisplayVideoConfig =
    ::protozero::proto_utils::FieldMetadata<
      142,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_DisplayVideoConfig kDisplayVideoConfig{};
  template <typename T = DisplayVideoConfig> T* set_display_video_config() {
    return BeginNestedMessage<T>(142);
  }

  void set_display_video_config_raw(const std::string& raw) {
    return AppendBytes(142, raw.data(), raw.size());
  }
