...
class SystemInfoConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/1> {
 public:
  ...
  bool has_irq_names() const { return at<1>().valid(); }
  bool irq_names() const { return at<1>().as_bool(); }
};
...
class SystemInfoConfig : public ::protozero::Message {
 public:
  ...
  static constexpr FieldMetadata_IrqNames kIrqNames{};
  void set_irq_names(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_IrqNames::kFieldId;
