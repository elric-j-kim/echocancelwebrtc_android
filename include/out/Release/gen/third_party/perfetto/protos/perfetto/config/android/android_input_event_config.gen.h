...
class PERFETTO_EXPORT_COMPONENT AndroidInputEventConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_trace_evdev_events() const { return _has_field_[5]; }
  bool trace_evdev_events() const { return trace_evdev_events_; }
  void set_trace_evdev_events(bool value) { trace_evdev_events_ = value; _has_field_.set(5); }
