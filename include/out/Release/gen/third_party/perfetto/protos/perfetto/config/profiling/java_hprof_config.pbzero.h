...
class JavaHprofConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10> {
 public:
  ...
  bool has_min_java_heap_size_kb() const { return at<9>().valid(); }
  uint32_t min_java_heap_size_kb() const { return at<9>().as_uint32(); }
  bool has_dump_smaps() const { return at<5>().valid(); }
  bool dump_smaps() const { return at<5>().as_bool(); }
  bool has_smaps_config() const { return at<8>().valid(); }
  ::protozero::ConstBytes smaps_config() const { return at<8>().as_bytes(); }
  ...
  bool has_dump_oome_callstack() const { return at<10>().valid(); }
  bool dump_oome_callstack() const { return at<10>().as_bool(); }
};
...
class JavaHprofConfig : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kMinJavaHeapSizeKbFieldNumber = 9,
    kDumpSmapsFieldNumber = 5,
    kSmapsConfigFieldNumber = 8,
    kIgnoredTypesFieldNumber = 6,
    kDumpOomeCallstackFieldNumber = 10,
  };
  ...
  using FieldMetadata_MinJavaHeapSizeKb =
    ::protozero::proto_utils::FieldMetadata<
      9,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_MinJavaHeapSizeKb kMinJavaHeapSizeKb{};
  void set_min_java_heap_size_kb(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_MinJavaHeapSizeKb::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  using FieldMetadata_SmapsConfig =
    ::protozero::proto_utils::FieldMetadata<
      8,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_SmapsConfig kSmapsConfig{};
  template <typename T = SmapsConfig> T* set_smaps_config() {
  ...
  using FieldMetadata_DumpOomeCallstack =
    ::protozero::proto_utils::FieldMetadata<
      10,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_DumpOomeCallstack kDumpOomeCallstack{};
  void set_dump_oome_callstack(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_DumpOomeCallstack::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
